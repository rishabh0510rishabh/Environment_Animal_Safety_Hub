 ...
 *
 * Comprehensive pet adoption system with advanced filtering, search functionality,
 * interactive modals, adoption forms, and user engagement features.
 *
 * Features:
 * - 8+ pet profiles with detailed information and images
 * - Advanced filtering by type, age, size, and gender
 * - Interactive pet modals with detailed information
 * - Adoption application form with validation
 * - Favorites system with heart animations
 * - Load more functionality with skeleton loading
 * - Scroll animations and parallax effects
 * - Notification system with multiple types
 * - URL parameter support for direct pet linking
 * - Lazy loading for performance optimization
 * - FAQ accordion functionality
 * - Success modal with application confirmation
 *
...
/**
 * Initialize all adoption page components when DOM is loaded
 */
...
/**
 * Comprehensive pet database with detailed information
 * Each pet object contains profile information, traits, health status, and adoption details
...
const petsData = {
    max: {
        ...
        description: "Max is a friendly and energetic Golden Retriever who loves to play fetch and go for long walks. He's great with children and other pets. Max has been fully vaccinated and is looking for a loving family to call his own.",
        traits: [
            "Friendly", "Playful", "Good with Kids", "Trained", "Energetic", "Loyal"
        ],
    ...
    whiskers: {
        ...
        badges: ["urgent"],
        description: "Whiskers is a beautiful Persian cat with stunning blue eyes. She's calm, affectionate, and loves to cuddle. Due to her previous owner relocating, she urgently needs a new home.",
    ...
    bruno: {
        ...
        badges: ["trained"],
        description: "Bruno is a well-trained German Shepherd with excellent obedience skills. He's protective, intelligent, and makes a great companion. Perfect for an active family with a spacious home.",
        traits: [
            "Intelligent", "Protective", "Trained", "Active", "Loyal", "Alert"
        ],
        health: "Vaccinated, Neutered, Microchipped",
        adoptionFee: "₹4,000"
    },
    luna: {
        ...
        badges: ["vaccinated"],
        description: "Luna is an adorable British Shorthair kitten with a playful personality. She loves chasing toys and exploring. Luna would make a perfect first pet for any family.",
    ...
    coco: {
        ...
        badges: ["new"],
        description: "Coco is a charming Cockatiel who loves to whistle and sing. He's hand-tamed and enjoys interacting with people. A perfect companion for bird lovers.",
        traits: [
            "Vocal", "Friendly", "Hand-tamed", "Musical", "Social", "Cheerful"
        ],
    ...
    buddy: {
        ...
        badges: ["friendly"],
        description: "Buddy is a sweet-natured Labrador who's excellent with children. He's patient, gentle, and loves family activities. Buddy is house-trained and knows basic commands.",
        traits: [
            "Kid Friendly", "Gentle", "Patient", "Trained", "Loving", "Playful"
        ],
        health: "Vaccinated, Neutered, Microchipped",
        adoptionFee: "₹3,500"
    },
    fluffy: {
        ...
        badges: ["vaccinated"],
        description: "Fluffy is an adorable Holland Lop rabbit with floppy ears and a sweet personality. She loves to hop around and enjoys gentle petting. Perfect for apartments.",
    ...
    simba: {
        ...
        badges: ["trained"],
        description: "Simba is a confident and friendly Orange Tabby. He's litter-trained, loves to play, and gets along well with other cats. Simba enjoys sunny spots and chin scratches.",
        traits: [
            "Confident", "Friendly", "Trained", "Social", "Playful", "Affectionate"
        ],
        health: "Vaccinated, Neutered, Microchipped",
        adoptionFee: "₹2,000"
    }
...
/**
 * Initialize filter tab functionality
 * Handles category-based filtering of pet cards
 */
...
/**
 * Filter pet cards based on selected category
 * @param {string} filter - Filter category (all, dog, cat, etc.)
 * @param {NodeList} petCards - Collection of pet card elements
 */
 ...
 * Animates numbers with K+ formatting for large values
 */
...
/**
 * Initialize hero statistics counter with different animation style
 */
 ...
 * Scrolls to pets section when category cards are clicked
 */
...
/**
 * Filter pets by category and scroll to results
 ...
 * Filters by type, age, size, and gender with smooth scrolling
 */
function searchPets() {
    ...
    petCards.forEach((card) => {
        ...
        const cardGender = card
            ...
            ?.classList.contains("male") ? "male" : "female";
...
/**
 * Reset all search filters and show all pets
 */
 ...
 * Handles heart icon toggling with animations
 */
 ...
 * Sets up modal open/close handlers and keyboard navigation
 */
...
/**
 * Open detailed pet modal with full information
...
function openPetModal(petId) {
    ...
    genderEl.innerHTML = pet.gender === "male"
        ? '<i class="fa-solid fa-mars"></i>'
        : '<i class="fa-solid fa-venus"></i>';
    genderEl.className = `modal-gender ${pet.gender === "male" ? "pet-gender male" : "pet-gender female"}`;
...
/**
 * Share pet information via Web Share API or clipboard
 */
function sharePet() {
    const modal = document.getElementById("petModal");
...
// ========== ADOPTION FORM SYSTEM ==========

/**
 * Initialize adoption form with validation and submission handling
 */
...
/**
 * Submit adoption form with loading states and success feedback
 * @param {HTMLFormElement} form - Adoption form element
 */
...
/**
 * Create skeleton loading card for load more functionality
...
/**
 * Remove all skeleton loading cards
 */
...
/**
 * Add more pets to the grid (simulated API response)
 */
function addMorePets() {
    ...
    morePets.forEach((pet, index) => {
        ...
        const badgesHTML = pet.badges
            .map(
                (badge) => `<span class="badge badge-${badge}">${badgeLabels[badge]}</span>`
            )
            .join("");
            ...
            <div class="pet-info">
                <div class="pet-header">
                    ...
                    <span class="pet-gender ${pet.gender}">
                        <i class="fa-solid fa-${pet.gender === "male" ? "mars" : "venus"}"></i>
                    </span>
                </div>
                <p class="pet-breed">${pet.breed}</p>
                <div class="pet-details">
                    <span><i class="fa-solid fa-cake-candles"></i> ${pet.age}</span>
                    <span><i class="fa-solid fa-weight-scale"></i> ${pet.size}</span>
...
/**
 * Initialize pet card hover effects
 */
...
/**
 * Initialize scroll-based animations and parallax effects
 */
...
/**
 * Check URL parameters for direct pet linking
 * Opens pet modal if pet parameter is present
 */
...
// Smooth scroll for adoption form links
