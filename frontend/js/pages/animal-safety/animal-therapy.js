// ===========================================
// ANIMAL THERAPY PROGRAMS - JAVASCRIPT
// ===========================================
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  storyCards.forEach(card => {
    card.addEventListener('mouseenter', function() {
      const icon = this.querySelector('.story-header i');
      if (icon) {
  ...
  orgCards.forEach(card => {
    card.addEventListener('mouseenter', function() {
      const link = this.querySelector('.org-link');
      if (link) {
  ...
  // ===========================================
  console.log('Animal Therapy Programs page loaded successfully');
  
  // Track how long users spend on page (optional)
  let pageLoadTime = new Date().getTime();
  
  window.addEventListener('beforeunload', () => {
    let timeSpent = (new Date().getTime() - pageLoadTime) / 1000;
    console.log(`User spent ${Math.round(timeSpent)} seconds on this page`);
  });
