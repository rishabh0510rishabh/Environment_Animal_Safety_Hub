/**
 * Kids Zone - Interactive Children's Gaming Hub
 *
 * A comprehensive gaming platform for children featuring educational games,
 * voice recognition activities, and environmental learning experiences.
 * Includes theme switching, animated backgrounds, and interactive game cards.
 *
 * Features:
 * - Dark/Light theme toggle with localStorage persistence
 * - Animated particle background effects
 * - Voice echo game with speech recognition
 * - Eco-themed word pronunciation practice
 * - Game progress tracking and scoring system
 * - Responsive card animations and hover effects
 *
 ...
 * Supports automatic dark mode detection based on system preferences
 */
...
/**
 * Dynamic particle background animation system
...
/**
 * Animate game cards with staggered delays for smooth entrance effects
 */
const animateCards = () => {
...
/**
 * Handle disabled game buttons with user feedback
 */
...
// ===== VOICE ECHO GAME SYSTEM =====
/**
 * Voice Echo Game - Speech Recognition Learning Game
 *
 * Interactive game that teaches children eco-themed vocabulary through
 * speech recognition and pronunciation practice. Features scoring,
...
// ===== ECO-THEMED WORD DATABASE =====
/**
 * Comprehensive eco-themed word database with phonetic pronunciations
 * and educational meanings for environmental learning
 * @typedef {Object} EcoWord
 * @property {string} word - The vocabulary word
 * @property {string} phonetic - IPA phonetic pronunciation guide
 * @property {string} meaning - Educational definition and context
 */
const ecoWords = [
...
// ===== VOICE GAME STATE MANAGEMENT =====
/**
 * Voice game state object tracking all game progress and statistics
 * @typedef {Object} VoiceGameState
 * @property {number} score - Current game score
 * @property {number} level - Current difficulty level
 * @property {number} streak - Current correct answer streak
 * @property {number} totalAttempts - Total pronunciation attempts
 * @property {number} correctAttempts - Number of correct pronunciations
 * @property {number} currentWordIndex - Index of current word being practiced
 * @property {boolean} isListening - Whether speech recognition is active
 * @property {Set<number>} completedWords - Set of completed word indices
...
// ===== VOICE GAME INITIALIZATION =====
/**
 * Initialize the voice echo game with fresh state and speech recognition setup
 */
...
/**
 * Update all game UI elements to reflect current state
 */
...
// ===== WORD BUBBLE SYSTEM =====
/**
 * Generate interactive word bubbles for visual progress tracking
 */
...
/**
 * Update word bubble states to show completion and current word
 */
...
/**
 * Evaluate spoken word against target word with flexible matching
...
function checkPronunciation(spokenWord) {
  ...
  // Simple check - allow close matches for educational purposes
...
// ===== FEEDBACK SYSTEM =====
/**
 * Display feedback messages with visual styling and animations
...
// ===== WORD NAVIGATION =====
/**
 * Move to the next incomplete word or reset if all completed
 */
function nextWord() {
...
// ===== MICROPHONE CONTROL =====
/**
 * Toggle speech recognition on/off with visual feedback
 */
